...
const ShoppingCart = () => {
  return (
    <div>
      ...
      <div className="hidden sm:block pt-10 bg-gradient-to-r from-gray-700 to-gray-600 h-screen">
        ...
        <div className="mx-auto w-11/12 lg:w-10/12 mt-10">
          <div className="grid grid-cols-5 font-semibold">
            ...
            <div className="text-white text-center p-3">20000</div>
          </div>
        </div>
      </div>
